  ...
  theme: {
    extend: {
      colors: {
        ...
        customViolet: '#7E3AF2',
        /** Neutral gray card/divider border in dark mode — no blue undertone */
        commonBorder: '#333333',
        // Status colors
      ...
      fontFamily: {
        ...
        testtiemposfine: ['"TestTiemposFine"', '"TestTiemposFineLight"', 'sans-serif'],
        'testtiemposfine-bold': ['"TestTiemposFine"', 'sans-serif'],
